...
/* exported customerDetailsPage__fetch */
function customerDetailsPage__fetch(id, auth) {
...
/* exported customerDetailsPage__render */
function customerDetailsPage__render($container, opt, opt2, id, query, model, auth, updateCallback) {
  $container.html(`
      ...
      <div class="navbar">
        <ul class="nav nav-tabs">
          <li class="nav-item active" role="presentation">
            <a href="#customers/${opt}/${opt2}/${model.id}" class="nav-link">Customer Request</a>
          </li>
