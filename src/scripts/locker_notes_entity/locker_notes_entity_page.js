...
/* global lockerNotesEntity__views */

/* exported lockerNotesEntityPage */
function lockerNotesEntityPage(app, $container, router, auth, opt1, query) {
